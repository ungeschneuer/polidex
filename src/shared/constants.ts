...
export const ACHIEVEMENTS: AchievementDef[] = [
  { id: 'first_catch',       name: 'Erstabdruck',             description: 'Erstes Sticker geklebt. Album-Eröffnung!' },
  { id: 'ten_caught',        name: 'Sammelfieber',            description: '10 Sticker im Album. Ein guter Anfang.' },
  { id: 'fifty_caught',      name: 'Albumheld*in',            description: '50 Sticker. Bis zum Heftrand ist es noch ein Stück.' },
  { id: 'hundred_caught',    name: 'Kioskbesitzer*in',        description: '100 Sticker. Genug für eine echte Tauschbörse.' },
  { id: 'two_hundred_caught',name: 'Bundestags-Versteher*in', description: '200 im Album. Du kennst das Parlament wie deine Westentasche.' },
  { id: 'ten_articles',      name: 'Frühstückslektüre',       description: '10 Artikel gescannt. Eine seriöse Tagesausbeute.' },
  { id: 'fifty_articles',    name: 'Pressespiegel',           description: '50 Artikel gescannt. Du hast eine Routine entwickelt.' },
  { id: 'hundred_articles',  name: 'Medien-Dauergast',        description: '100 Artikel gescannt. Bist du Korrespondent*in?' },
  { id: 'streak_3',          name: 'Drei Tage durch',         description: '3-Tage-Serie geschafft. XP-Bonus aktiviert.' },
  { id: 'streak_7',          name: 'Wochenausgabe',           description: '7-Tage-Serie. Eine ganze Heft-Ausgabe lang dabei.' },
  { id: 'streak_30',         name: 'Vollabo',                 description: '30-Tage-Serie. Maximaler Bonus, voll ausgereizt.' },
  { id: 'catch_epic',        name: 'Kenner*in',               description: 'Jemand mit geringer Medienpräsenz gesammelt. Echtes Insider-Wissen!' },
  { id: 'catch_headline',    name: 'Schlagzeilenjäger*in',    description: 'Jemand aus der Headline gesammelt. Gut aufgepasst!' },
  { id: 'level_5',           name: 'Talkshow-Stammgast',      description: 'Eine*n MdB auf Level 5 gebracht.' },
  { id: 'level_10',          name: 'Brennpunkt-Veteran*in',   description: 'Eine*n MdB auf Level 10 gebracht. Viel politisches Engagement.' },
  { id: 'catch_veteran',     name: 'Veteran*in im Album',     description: 'Jemand mit 4+ Wahlperioden geklebt.' },
  { id: 'catch_legend',      name: 'Parlamentarische Legende',description: 'Jemand mit 6+ Wahlperioden — eine parlamentarische Institution.' },
  { id: 'catch_historical',  name: 'Aus dem Archiv',          description: 'Eine*n ehemalige*n MdB aus einer früheren WP gesammelt.' },
  { id: 'all_periods',       name: 'Von Schröder bis Merz',   description: 'Mindestens eine*r aus allen Wahlperioden 16 – 21.' },
  { id: 'type_collector',   name: 'Ausschuss-Connaisseur*in', description: '8 verschiedene Politiker-Typen im Album.', icon: '\u{1F52C}' },
  { id: 'faction_sweep',    name: 'Querbeet-Sammler*in',      description: 'Mindestens eine*r aus jeder aktiven Fraktion.', icon: '\u{1F308}' },
  { id: 'five_obscure',     name: 'Hinterzimmer-Insider*in',  description: '5 mit sehr geringer Medienpräsenz gesammelt.', icon: '\u{1F47B}' },
  { id: 'level_20',         name: 'Maximum Talkshow',         description: 'Eine*n MdB auf Level 20 gebracht. H\u00F6chste politische Pr\u00E4senz.', icon: '\u2B50' },
  { id: 'total_xp_500',     name: 'XP-Dauerläufer*in',        description: '500 XP über alle Politiker*innen — beeindruckendes Engagement.', icon: '\u{1F4AA}' },
];
